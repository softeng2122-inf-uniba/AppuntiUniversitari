...
void build_grafo(Grafo &G, int &num_nodi)
...
void trova_route( Grafo G, Ins &V, Lista &L, Grafo :: nodo i,
                  Grafo :: nodo j, Grafo :: boolean &flag )
...
//la procedura stampa la lista popolata dalla
//chiamata della funzione trova_route(),
//inoltre calcola il peso totale degli archi
//che attraversano nell'ordine i nodi della lista
	{
      Grafo :: nodo i,j;
...
//dove l'elemento aij rappresenta
